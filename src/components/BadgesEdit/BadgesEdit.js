            ...
            <ScrollView style={styles.container}>
                <View style={styles.content}>
                    ...
                    <View style={styles.form}>
                        ...
                        />
                        <Text style={styles.inputText}>Games</Text>
                        <TextInput
                            style={styles.input}
                            placeholder={`${badge.games}`}
                            onChangeText={text => {
                                this.setState(prevState => {
                                    let form = Object.assign({}, prevState.form);
                                    form.games = text;
                        ...
                        />
                        <Text style={styles.inputText}>Achievements</Text>
                        <TextInput
                            style={styles.input}
                            placeholder={`${badge.achievements}`}
                            onChangeText={text => {
                                this.setState(prevState => {
                                    let form = Object.assign({}, prevState.form);
                                    form.achievements = text;
                                    return { form };
                                });
                            }}
                        />
